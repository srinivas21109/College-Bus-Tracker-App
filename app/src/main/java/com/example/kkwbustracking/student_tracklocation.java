...
//    String licence_no = "Atharva2204";
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        else if(id==R.id.feedback)
        {
            ...
            email.putExtra(Intent.EXTRA_EMAIL,new String[]{"201fa04433@gmail.com"});
            email.putExtra(Intent.EXTRA_SUBJECT,"FEEDBACK");
            email.putExtra(Intent.EXTRA_TEXT,"Give feedback in brief");
            startActivity((Intent.createChooser(email,"Gmail APP")));
        }
        else
        {
    ...
    public void route_dialog()
    {
        ...
        String[] routes = {"BUS - A (1)", "BUS - B (2)", "BUS - C (3)","BUS - D (4)","BUS - E (5)"};
...
//        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
    ...
    public void onRoutingSuccess(ArrayList<Route> route, int shortestRouteIndex)
    {
        ...
        for (int i = 0; i < route.size(); i++)
        {
            ...
            polyOptions.color(getResources().getColor(R.color.yellow,getTheme()));
